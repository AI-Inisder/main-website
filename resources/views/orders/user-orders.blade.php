...
@php
    $headTitle = 'My Orders - AI Insider';
    $css =
            ...
            <div class="card">
                ...
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($order['pricing_type'])
                                                ...
                                                @if($order['formatted_order_amount'])
                                        ...
                                        <td>
                                            @if(isset($order['google_drive_link']) && $order['google_drive_link'])
                                                <a href="{{ $order['google_drive_link'] }}" target="_blank" class="btn btn-sm btn-success">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            @if($pagination['current_page'] > 1)
                                                <a href="?page={{ $pagination['current_page'] - 1 }}" class="btn btn-sm btn-outline-primary">Previous</a>
                                            @endif
                                            ...
                                            @if($pagination['current_page'] < $pagination['last_page'])
                                                <a href="?page={{ $pagination['current_page'] + 1 }}" class="btn btn-sm btn-outline-primary">Next</a>
                                            @endif
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('orders.track') }}" class="btn btn-secondary">Track Order</a>
                    </div>
                </div>
            </div>
        </div>
